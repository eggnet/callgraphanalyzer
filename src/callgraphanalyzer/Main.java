...
public class Main {
	...
	public static void main(String[] args) {
		...
		parser.parseFileFromFile("/home/jordan/Documents/testproject/src/models/Date.java");
...
//		parser.parseFileFromString("src/test/A.java", db.getRawFile("src/test/A.java", "f4672afd22f79dde79a4248b66616591db40befc")); // testing
